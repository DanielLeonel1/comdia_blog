...
$cereales_sin = $sentencia->fetchAll(PDO::FETCH_OBJ);
...
<table class="table table-bordered">
  <thead>
    <tr class="" style="color: #fff; background-color:  #9b5d0c">
      ...
      <?php
        foreach ($cereales_sin as $dato) {
          ...
          <td style="background-color:  #fff">
            ...
            <?php  
            if ($dato->alim_id_tipo_alimento == 2){
              echo "Cereales";
            }else{
              echo "No son Cereales";
            }
            ?>
