...
$sentencia = $conexion->query("SELECT * FROM platillos WHERE tipo_platillo = 'Cena' AND id_usuario_platillo='$id_usuario' ORDER BY fecha_hora_platillo DESC ");
$cena = $sentencia->fetchAll(PDO::FETCH_OBJ);

?>

<?php
        foreach ($cena as $dato) {
            ?>
