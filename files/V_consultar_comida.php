...
$sentencia = $conexion->query("SELECT * FROM platillos WHERE tipo_platillo = 'Comida' AND id_usuario_platillo='$id_usuario' ORDER BY fecha_hora_platillo DESC ");
$comida = $sentencia->fetchAll(PDO::FETCH_OBJ);

?>

<?php
        foreach ($comida as $dato) {
            ?>
